...
def GameOver():
    ...
    pygame.display.set_caption("TranSlay")   #caption on top of window
    
    #pygame.load('C:\Users\koenf\Projects\Shell Hacks\Floor.png')
    #title= GIFImage('TranSlay.gif')
    gameOver = GIFImage("gameover.gif")   
    ...
    background3 = GIFImage("Background3sized.gif") 
    ...
    while True:
        ...
        background3.render(window, (20, 0))
        #largeText = pygame.font.Font('freesansbold.ttf',60)
        #TextSurf, TextRect = text_objects("Snakey Snake", largeText, (0,0,0))
        #TextRect.center = ((500/2),(500/2))
        #window.blit(TextSurf, TextRect)
        #background2.render(window, (20, 0))
        #title.render(window, (250,100))
        gameOver.render(window,(200,100))
        #pygame.draw.rect(window, pygame.Color(225,40,0), pygame.Rect(175,310,150,50))
        #button("BATTLE",500,240,200,80,(203,30,36), (100,100,100), Game)
        button("TRY AGAIN",500,400,200,80,(203,30,36), (100,100,100), Game)
        button("EXIT",500,500,200,80,(203,30,36), (100,100,100), GameIntro)
        #button("EDIT LANGUAGE",500,540,200,80,(203,30,36), (100,100,100), Game)
...
def GameIntro():
    ...
    #pygame.load('C:\Users\koenf\Projects\Shell Hacks\Floor.png')
    #title= GIFImage('TranSlay.gif')
    title = pygame.image.load('TranSlay.png')
    background2 = GIFImage("Background3sized.gif")    
    ...
    while intro:
        ...
        #pygame.draw.rect(window, pygame.Color(225,40,0), pygame.Rect(175,310,150,50))
        button("BATTLE",500,240,200,80,(203,30,36), (100,100,100), Game)
        button("TRAIN",500,340,200,80,(203,30,36), (100,100,100), Game)
        button("EDIT SET",500,440,200,80,(203,30,36), (100,100,100), Game)
        button("EDIT LANGUAGE",500,540,200,80,(203,30,36), (100,100,100), Game)
...
#
    ...
    while True:
       ...
       # if player1.getRight != True:
        ...
        elif questionsRight == 3:
            drawQuestion(window, "What is \"can\" in Spanish?", spanishVerbs[3][1], spanishVerbs[3][2], spanishVerbs[3][0])
            spanishVerb3 = Question('Spanish', 'Easy', spanishVerbs[3][3], spanishVerbs[3][2], spanishVerbs[3][1], spanishVerbs[3][0])
            
        elif questionsRight == 4:
            drawQuestion(window, "What is \"to say\" in Spanish?", spanishVerbs[4][1], spanishVerbs[4][2], spanishVerbs[4][0])
            spanishVerb2 = Question('Spanish', 'Easy', spanishVerbs[4][3], spanishVerbs[4][2], spanishVerbs[4][1], spanishVerbs[4][0])
